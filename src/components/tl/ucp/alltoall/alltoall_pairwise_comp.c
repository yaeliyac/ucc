...
void ucc_tl_ucp_alltoall_pairwise_comp_progress(ucc_coll_task_t *coll_task)
{
    ...
    size_t             data_size;
    ucc_tl_ucp_compress_metadata_t *metadata = task->alltoall_pairwise.metadata;
...
ucc_status_t ucc_tl_ucp_alltoall_pairwise_comp_init_common(ucc_tl_ucp_task_t *task)
{
    ...
    task->super.post     = ucc_tl_ucp_alltoall_pairwise_comp_start;
    task->super.progress = ucc_tl_ucp_alltoall_pairwise_comp_progress;
    ...
    cudaHostAlloc((void**)&task->alltoall_pairwise.metadata, sizeof(ucc_tl_ucp_compress_metadata_t), cudaHostAllocDefault);
