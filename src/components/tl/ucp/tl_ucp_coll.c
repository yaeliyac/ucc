    ...
    case UCC_COLL_TYPE_ALLGATHER:
        ...
        case UCC_TL_UCP_ALLGATHER_ALG_LINEAR_BATCHED:
            *init = ucc_tl_ucp_allgather_linear_batched_init;
            break;
        case UCC_TL_UCP_ALLGATHER_ALG_LINEAR_COMP:
            *init = ucc_tl_ucp_allgather_linear_comp_init;
            break;
        default:
    ...
    case UCC_COLL_TYPE_ALLTOALL:
        ...
        case UCC_TL_UCP_ALLTOALL_ALG_PAIRWISE:
            *init = ucc_tl_ucp_alltoall_pairwise_init;
            break;
        case UCC_TL_UCP_ALLTOALL_ALG_PAIRWISE_COMP:
            *init = ucc_tl_ucp_alltoall_pairwise_comp_init;
            break;
